                ...
                <div className="container">
                    <div className="navbar-inner">
                        ...
                        <div className="nav-menu menu____">
                            <ul>
                                <li><a href="#">Home<span className="dd-trigger"><i
                                ...
                                <li><a href="#">News<span className="dd-trigger"><i
                                    className="far fa-angle-down"></i></span></a>
                                    <ul className="submenu">
                        ...
                        <div className="navbar-extra d-flex align-items-center"><a
                            ...
                            className="far fa-arrow-right"></i></a><a href="#" className="nav-toggler"><span></span></a>
                        </div>
                    </div>
                </div>
            </div>
